    ...
    <ScrollTop/>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="community/notice/:results" element={<Community gnb1="열린공간" gnb2="공지사항" data="notice" />} />
          ...
          <Route path="community/faq/:results" element={<Community gnb1="열린공간" gnb2="공지사항" data="notice" />} />
          <Route path="community/freeboard" element={<Community gnb1="열린공간" gnb2="자유게시판" data="freeboard" />} />
          <Route path="community/freeboard/:results" element={<Community gnb1="열린공간" gnb2="자유게시판" data="freeboard" />} />
